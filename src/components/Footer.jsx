      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-wrap md:gap-0 gap-8">
          ...
          <div className="w-full md:w-1/4">
            ...
            <p className="text-gray-400">
              Shop No.3, New Surya Kiran CHS. Ltd., Opp. Galaxy Hotel, S.T.
              Depot Rd., Nallasopara (W) - 401 203.
            </p>
            <p className="text-gray-400">Phone: +91 7977416857</p>
            <p className="text-gray-400">Email: hamdankachhawa96@gmail.com</p>
          </div>
          <div className="w-full md:w-1/4">
